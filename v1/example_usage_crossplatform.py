"""
Example Usage of Manifold System v1 - Cross-Platform Version
...
# Create outputs directory in current folder
...
def example_basic_usage():
    ...
    output_path = OUTPUT_DIR / 'example_pca.png'
    ...
    output_path = OUTPUT_DIR / 'example_tsne.png'
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"   Saved: {output_path}")
...
def example_trajectory_analysis():
    ...
    output_path = OUTPUT_DIR / 'example_trajectories.png'
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"   Saved: {output_path}")
...
def example_method_comparison():
    ...
    output_path = OUTPUT_DIR / 'example_comparison.png'
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"   Saved: {output_path}")
    ...
    if 'pca' in projections:
        ...
        output_path = OUTPUT_DIR / 'example_variance.png'
        plt.savefig(output_path, dpi=150, bbox_inches='tight')
        print(f"   Saved: {output_path}")
